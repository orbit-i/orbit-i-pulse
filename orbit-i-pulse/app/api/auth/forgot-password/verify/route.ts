...
// Step 2 of self-serve reset: check the security answer for the given
// email. On success, issue a short-lived (10 min) reset token the
// client will send to /reset along with the new password. Never
// issues a session cookie here — answering the question correctly is
// not the same as logging in.
