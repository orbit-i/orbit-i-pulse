...
import {
  ...
  BriefcaseIcon, PlaneIcon, BuildingIcon, MegaphoneIcon, NetworkIcon,
} from "@/components/icons";
import { Avatar, StatusBadge, RoleBadge } from "@/components/ui-bits";
import { workspaceLane, canManageUsers } from "@/lib/permissions";

type Me = { fullName: string; role: string; userId: string; jobTitle?: string | null; departmentName?: string | null };
...
export default function OverviewPage() {
  ...
  return (
    <main className="dash-content fade-up">
      ...
      <div style={{ display: "grid", gridTemplateColumns: lane === "individual" ? "1fr" : "1.3fr 1fr", gap: "1.1rem", marginBottom: "1.25rem" }}>
        {/* My work — everyone */}
        <div className="card">
