...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    setError("");
    if (!fullName.trim() || !email.trim() || !password || !securityAnswer.trim()) {
      ...
      <div className="auth-form-side">
        <div className="auth-card fade-up">
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="field">
              <label className="field-label" htmlFor="phone">Phone number <span className="text-muted">(optional)</span></label>
              <div style={{ position: "relative" }}>
                <span style={{ position: "absolute", left: "0.75rem", top: "50%", transform: "translateY(-50%)", color: "var(--gray-400)", pointerEvents: "none", display: "flex" }}>
                  <PhoneIcon size={15} />
                </span>
