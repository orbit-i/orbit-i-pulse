...
// 1) email + registration number -> fetch security question
...
import { REG_NUMBER_EXAMPLE } from "@/lib/reg-number";
  ...
  async function handleLookup(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/auth/forgot-password/question", {
        ...
        body: JSON.stringify({ email: email.trim(), registrationNumber: registrationNumber.trim() }),
      });
      ...
      <div className="auth-stage">
        ...
        <div className="auth-stage-content">
          ...
          <p className="auth-stage-sub">
            Verify your registration number and security answer to set a new password — no email needed.
          </p>
        </div>
      </div>
