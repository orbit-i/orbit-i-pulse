...
export function canManageUsers(role: string): boolean {
  return ["admin", "founder", "co_founder", "ceo", "cto", "coo", "hr_manager"].includes(role);
}

export function canChangeRoles(role: string): boolean {
  // Only the system owner and the two founders can re-org people.
  return ["admin", "founder", "co_founder", "ceo", "cto", "coo"].includes(role);
}
...
export function canViewAllAttendance(role: string): boolean {
  return ["admin", "founder", "co_founder", "ceo", "cto", "coo", "hr_manager", "associate_hr", "manager"].includes(role);
}
...
export function canApproveLeave(role: string): boolean {
  return ["admin", "founder", "co_founder", "ceo", "cto", "coo", "hr_manager", "associate_hr", "manager", "team_lead"].includes(role);
}

// Can assign tasks to other people (vs. only managing their own)
export function canAssignTasks(role: string): boolean {
  return ["admin", "founder", "co_founder", "ceo", "cto", "coo", "hr_manager", "manager", "team_lead"].includes(role);
}
...
export function canManageTeams(role: string): boolean {
  return ["admin", "founder", "co_founder", "ceo", "cto", "coo", "hr_manager", "manager"].includes(role);
}
